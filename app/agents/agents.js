...
var Elm = {};
Elm['Agents'] = Elm['Agents'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Agents'], 'Agents', typeof _user$project$Agents$main === 'undefined' ? null : _user$project$Agents$main);
